...
@Component({
  selector: 'app-ventas-externas',
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './ventas-externas.html',
  styleUrl: './ventas-externas.scss',
})
export class VentasExternas {
  lista: Estudiante[] = [];
  ...
  async generarFactura() {
    this.ventaForm.patchValue({
      estudiante: this.ventaForm.get('estudianteDoc')?.value,
    });
    const hoy = new Date();
